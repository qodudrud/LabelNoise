...
def main():
    ...
    perturb_eps = [0.0001, 0.0005, 0.005, 0.05]
    perturb_taus = [5e-2, 1e-1, 5e-1, 1, 5, 50]
...
python -u main.py \\
  ...
  --data {data} \\
  --noise-rate 0.0 \\
  --save-path results/{data}/{model}_m1_w1/{optim}_{perturb_type}_{scheduler}/eps_{perturb_ep}/tau_{perturb_tau}/seed_{seed} \\
  --model {model} \\
